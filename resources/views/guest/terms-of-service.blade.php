    ...
    <div class="ui center aligned grid">
        <div class="row">
            <div class="black column">
                <h1>Shines Services - Terms and Conditions ("Terms")</h1>
                <p>Last updated: April 22, 2017</p>
            </div>
        </div>
        <div class="row">
            <div class="column">
                <div class="ui text justified container">
                    <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using
                        the http:shines.app:8000 website (the "Service") operated by Shines Services ("us", "we", or
                        "our").</p>
                    ...
                    <p>By accessing or using the Service you agree to be bound by these Terms. If you disagree with any
                        part of the terms then you may not access the Service. This Terms & Conditions agreement is
                        licensed by <a href="https://termsfeed.com">TermsFeed</a> to Shines Services.</p>
                    ...
                    <p>Our Service may contain links to third-party web sites or services that are not owned or
                        controlled by Shines Services.</p>

                    <p>Shines Services has no control over, and assumes no responsibility for, the content, privacy
                        policies, or practices of any third party web sites or services. You further acknowledge and
                        agree that Shines Services shall not be responsible or liable, directly or indirectly, for any
                    ...
                    <p>These Terms shall be governed and construed in accordance with the laws of Indonesia, without
